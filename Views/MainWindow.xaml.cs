...
public partial class MainWindow : System.Windows.Window
{
    ...
    private void JsonDropZone_PreviewMouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
    {
    ...
    private void JsonDropZone_PreviewDragOver(object sender, System.Windows.DragEventArgs e)
    {
    ...
    private async void JsonDropZone_Drop(object sender, System.Windows.DragEventArgs e)
    {
        if (e.Data.GetData(System.Windows.DataFormats.FileDrop) is string[] files)
        {
            if (ViewModel is not null)
            {
                await ViewModel.ImportJsonFilesAsync(files);
            }
        }
    }

    private async void JsonDropZone_PreviewKeyDown(object sender, System.Windows.Input.KeyEventArgs e)
    {
        ...
        if (System.Windows.Clipboard.ContainsText())
        {
            if (ViewModel is not null)
            {
                await ViewModel.ImportJsonFromClipboardTextAsync(System.Windows.Clipboard.GetText());
            }
            e.Handled = true;
        }
    }
